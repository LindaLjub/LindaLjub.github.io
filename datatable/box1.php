...
function box1() {
    ...
    $sql="select * from highscorevuxna order by points"; 
    ...
    $out.='<th>Poäng:</th><th>Förnamn:</th><th>Efternamn:</th><th>MedlemsID:</th>';
    $out.='</tr>';
    $out.='</thead>';
    ...
    while ($row=$result->fetch_array()) {
        ...
        $out.=$row['points']; // lägger till tid i tabellcellen
        $out.='</td>'; // avslutar tabellcellen.
        
        $out.='<td>'; // en cell i tabellraden
        $out.=$row['name']; // lägger till flygnr i tabellcellen
        $out.='</td>'; // avslutar tabellcellen.
        
        $out.='<td>'; // en cell i tabellraden
        $out.=$row['lastname']; // lägger till airport i tabellcellen
        $out.='</td>'; // avslutar tabellcellen.
        
       $out.='<td>'; // en cell i tabellraden
        $out.=$row['id']; // lägger till airport i tabellcellen
        $out.='</td>'; // avslutar tabellcellen.
