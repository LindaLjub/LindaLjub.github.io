...
$out.='<tr>';
$out.='<th>Poäng:</th><th>Förnamn:</th><th>Efternamn:</th><th>Redigera:</th><th>Radera:</th>';
$out.='</tr>'; 
$out.='</thead>';    
...
while ($row=$result->fetch_array()) {
    ...
    $out.='<td>'; // Skapar en tabellrad
    $out.="<a href='redigera.php?redpoints=".$row['points']."&redname=".$row['name']."'>Redigera poäng</a>";
    $out.='</td>'; // avslutar tabellcellen
